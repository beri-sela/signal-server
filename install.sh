...
cd ~/signal/Signal-Server and git checkout v4.97
...
java -jar ~/signal/Signal-Server/service/target/TextSecureServer-4.97.jar server ~/signal/Signal-Server/config.yml
